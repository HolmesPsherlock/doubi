...
#### 下载安装:
``` bash
wget -N --no-check-certificate https://raw.githubusercontent.com/HolmesPsherlock/doubi/master/ssr.sh && chmod +x ssr.sh && bash ssr.sh
```
...
#### 下载安装:
``` bash
wget -N --no-check-certificate https://raw.githubusercontent.com/HolmesPsherlock/doubi/master/caddy_install.sh && chmod +x caddy_install.sh && bash caddy_install.sh
 # 安装插件：
...
# 卸载命令：
wget -N --no-check-certificate https://raw.githubusercontent.com/HolmesPsherlock/doubi/master/caddy_install.sh && chmod +x caddy_install.sh && caddy_install.sh uninstall
```
